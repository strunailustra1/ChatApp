//
//  OperationDataManagerMock.swift
//  ChatAppTests
//
...
class OperationDataManagerMock: ProfileDataManagerProtocol {
    
    struct SaveParams: Equatable {
        let profile: Profile
        let changedFields: ProfileChangedFields
        
        static func == (lhs: OperationDataManagerMock.SaveParams, rhs: OperationDataManagerMock.SaveParams) -> Bool {
